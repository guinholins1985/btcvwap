...
const KeyLevelsCard: React.FC<KeyLevelsCardProps> = ({ vwap, pivots, fibonacci, currentPrice, ema50, ema200 }) => {
  ...
  return (
    <div className="bg-shark p-4 md:p-6 rounded-lg shadow-lg border border-tuna h-full">
      ...
      <div className="space-y-2">
        ...
        {ema200 > 0 && <LevelRow label="EMA 200 (Tendência)" value={ema200} colorClass="text-orange-accent font-bold" isResistance={currentPrice < ema200} currentPrice={currentPrice} />}
        ...
        {ema50 > 0 && <LevelRow label="EMA 50 (Dinâmico)" value={ema50} colorClass="text-pink-accent" isResistance={currentPrice < ema50} currentPrice={currentPrice} />}
